...
function SearchScreen(){
  ...
  return (
    <View style={styles.containerSearchScreen}>
      <View style={styles.searchDestiny}>
        <TextInput value={input} onChangeText={(text: string) => setInput(text)} placeholder='Entre com seu Destino' placeholderTextColor='gray' />
        <Feather name="search" size={22} color="black" />
      </View>

      <SearchResults data={data} input={input} setInput={setInput} nav={navigation} />
    </View>
  );
}
